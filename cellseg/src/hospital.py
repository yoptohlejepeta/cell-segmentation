...
def analysis(data_path,output_path,note=''):
    ...
    try:
        default_output_path = create_directories_for_results(output_path,N,list_of_input_data,note)
    except:
...
def img_processing_2(img,output_path):
    ...
    plt.imsave(f'{output_path}IMG/04_blue_channel_otsu_noise_removed.jpg', b_bin_otsu_morp, cmap='gray')
    ...
    plt.imsave(f'{output_path}IMG/05_nuclei_labeled_removed_small.jpg', img_labeled_nuclei, cmap='jet')
    ...
    img_boundary_in_original = iw.boundary_to_original_image(img, img_nuclei_boundary, width, height, [255, 0, 0])
    ...
    plt.imsave(f'{output_path}IMG/13_mul_otsu_labeled_removed_small_cyto.jpg', img_labeled_cytoplasm, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/14_cytoplasm_boundary.jpg', img_cytoplasm_boundary_bin, cmap='gray')

    img_boundary_in_original = iw.boundary_to_original_image(img, img_cytoplasm_boundary, width, height, [0, 255, 0])
    ...
    plt.imsave(f'{output_path}IMG/16_cytoplasm_nuclei_boundary.jpg', cytoplasm_nuclei_boundary, cmap='gray')
    ...
    img_cytoplasm_nuclei = iw.flooding_cytoplasm(img_labeled_cytoplasm, img_labeled_nuclei, width, height)
    ...
    plt.imsave(f'{output_path}IMG/19_flooding_cytoplasm_boundary.jpg', img_cytoplasm_boundary, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/20_cytoplasm_nuclei_boundary.jpg', cytoplasm_separated_nuclei_boundary, cmap='gray')
    ...
    img_only_cytoplasm_threshold, img_b_in_cytoplasm_mask = iw.threshold_in_mask(b2, img_only_cytoplasm_bin, width,height)
    plt.imsave(f'{output_path}IMG/23_only_cytoplasm_in_blue_channel.jpg', img_b_in_cytoplasm_mask, cmap='gray')
    plt.imsave(f'{output_path}IMG/24_only_cytoplasm_threshold_in_mask.jpg', img_only_cytoplasm_threshold, cmap='gray')

    img_cytoplasm_and_nuclei_bin = img_only_cytoplasm_threshold + b_bin_otsu_morp
    plt.imsave(f'{output_path}IMG/25_cytoplasm_and_nuclei_bin.jpg', img_cytoplasm_and_nuclei_bin, cmap='gray')

    img_cytoplasm_and_nuclei_labeled = img_cytoplasm_and_nuclei_bin * img_cytoplasm_nuclei
    plt.imsave(f'{output_path}IMG/26_cytoplasm_and_nuclei_labeled.jpg', img_cytoplasm_and_nuclei_labeled, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/29_only_cytoplasm_with_nuclei.jpg', img_only_cytoplasm_with_nuclei, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/30_only_cytoplasm_with_nuclei_without_small_reg.jpg',img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/31_only_cytoplasm_with_nuclei_without_small_reg_repaired.jpg',img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/32_only_cytoplasm_with_nuclei_boundary.jpg',boundary_img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/33_only_cytoplasm_which_have_nuclei.jpg',only_cytoplasm_which_have_nuclei_but_not_included, cmap='jet')
    ...
    # ---------------------------------------------------------------------------------------------------------------- #
    # Histogramy
    vw.histogram_2D_data_range(r1, 'Red channel', 'Value', 'Frequency', '01_Red_pil', output_path, 0, 255, 1, txt_file=True)
    vw.histogram_2D_data_range(g1, 'Green channel', 'Value', 'Frequency', '02_Green_pil', output_path, 0, 255, 1,txt_file=True)
    vw.histogram_2D_data_range(b1, 'Blue channel', 'Value', 'Frequency', '03_Blue_pil', output_path, 0, 255, 1,txt_file=True)

    vw.histogram_2D_data_range(r2, 'Red channel', 'Value', 'Frequency', '04_Red_cca', output_path, 0, 255, 1, txt_file=True)
    vw.histogram_2D_data_range(g2, 'Green channel', 'Value', 'Frequency', '05_Green_cca', output_path, 0, 255, 1,txt_file=True)
    vw.histogram_2D_data_range(b2, 'Blue channel', 'Value', 'Frequency', '06_Blue_cca', output_path, 0, 255, 1,txt_file=True)
...
def img_processing_3(img, output_path):
    ...
    img_labeled_nuclei = iw.remove_small_regions(img_labeled_nuclei, min_size=100)
    plt.imsave(f'{output_path}IMG/06_nuclei_labeled_removed_small.jpg', img_labeled_nuclei, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/15_flooding_cytoplasm_no_bordering.jpg', img_cytoplasm_nuclei, cmap='jet')
    ...
    img_cytoplasm_boundary = sd.get_boundary_4_connected(img_labeled_cytoplasm, width, height)
    img_cytoplasm_boundary_bin = cw.convert_labeled_to_bin(img_cytoplasm_boundary)
    plt.imsave(f'{output_path}IMG/19_cytoplasm_boundary.jpg', img_cytoplasm_boundary_bin, cmap='gray')
    ...
    cytoplasm_nuclei_boundary = img_cytoplasm_boundary_bin + img_nuclei_boundary_bin
    cytoplasm_nuclei_boundary = cw.convert_labeled_to_bin(cytoplasm_nuclei_boundary)
    plt.imsave(f'{output_path}IMG/21_cytoplasm_nuclei_boundary.jpg', cytoplasm_nuclei_boundary, cmap='gray')

    boundary_original_img = iw.boundary_to_original_image(img, cytoplasm_nuclei_boundary, width, height)
    plt.imsave(f'{output_path}IMG/22_cytoplasm_nuclei_boundary.jpg', boundary_original_img)

    img_cytoplasm_boundary = sd.get_boundary_4_connected(img_cytoplasm_nuclei, width, height)
    plt.imsave(f'{output_path}IMG/23_flooding_cytoplasm_boundary.jpg', img_cytoplasm_boundary, cmap='jet')

    img_original_boundary_cytoplasm_nuclei = iw.two_boundary_types_to_original_image(img, img_nuclei_boundary,
                                                                                     img_cytoplasm_boundary,
                                                                                     width, height)
    plt.imsave(f'{output_path}IMG/23_boundary_final_skoro.jpg', img_original_boundary_cytoplasm_nuclei)

    img_cytoplasm_boundary_bin = cw.convert_labeled_to_bin(img_cytoplasm_boundary)
    cytoplasm_separated_nuclei_boundary = img_cytoplasm_boundary_bin + img_nuclei_boundary_bin
    cytoplasm_separated_nuclei_boundary = cw.convert_labeled_to_bin(cytoplasm_separated_nuclei_boundary)
    plt.imsave(f'{output_path}IMG/24_cytoplasm_nuclei_boundary.jpg', cytoplasm_separated_nuclei_boundary, cmap='gray')
    ...
    img_only_cytoplasm_threshold, img_b_in_cytoplasm_mask = iw.threshold_in_mask(b2, img_only_cytoplasm_bin, width,
                                                                                 height)
    plt.imsave(f'{output_path}IMG/27_only_cytoplasm_in_blue_channel.jpg', img_b_in_cytoplasm_mask, cmap='gray')
    plt.imsave(f'{output_path}IMG/28_only_cytoplasm_threshold_in_mask.jpg', img_only_cytoplasm_threshold, cmap='gray')

    img_cytoplasm_and_nuclei_bin = img_only_cytoplasm_threshold + b_bin_otsu_morp
    plt.imsave(f'{output_path}IMG/29_cytoplasm_and_nuclei_bin.jpg', img_cytoplasm_and_nuclei_bin, cmap='gray')

    img_cytoplasm_and_nuclei_labeled = img_cytoplasm_and_nuclei_bin * img_cytoplasm_nuclei
    plt.imsave(f'{output_path}IMG/30_cytoplasm_and_nuclei_labeled.jpg', img_cytoplasm_and_nuclei_labeled, cmap='jet')

    cytoplasm_sizes = mh.labeled.labeled_size(img_cytoplasm_and_nuclei_labeled)
    cytoplasm_sizes[0] = 0
    number_of_cells = cytoplasm_sizes.shape[0]

    coordinates_cytoplasm = sd.get_coordinates_of_pixels(img_cytoplasm_and_nuclei_labeled, cytoplasm_sizes,
    ...
    img_only_cytoplasm_with_nuclei = iw.get_cytoplasm_which_have_nuclei(img_repaired, nr_nuclei)
    plt.imsave(f'{output_path}IMG/33_only_cytoplasm_with_nuclei.jpg', img_only_cytoplasm_with_nuclei, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/34_only_cytoplasm_with_nuclei_without_small_reg.jpg',
               img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')

    img_only_cytoplasm_with_nuclei_removed_small = cw.convert_labeled_to_bin(
        img_only_cytoplasm_with_nuclei_removed_small) * img_repaired
    plt.imsave(f'{output_path}IMG/35_only_cytoplasm_with_nuclei_without_small_reg_repaired.jpg',
               img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/36_only_cytoplasm_with_nuclei_boundary.jpg',
               boundary_img_only_cytoplasm_with_nuclei_removed_small, cmap='jet')
    ...
    plt.imsave(f'{output_path}IMG/37_only_cytoplasm_which_have_nuclei.jpg',
               only_cytoplasm_which_have_nuclei_but_not_included, cmap='jet')
    ...
    # ---------------------------------------------------------------------------------------------------------------- #
    # Histogramy
    vw.histogram_2D_data_range(r1, 'Red channel', 'Value', 'Frequency', '01_Red_pil', output_path, 0, 255, 1,
                               txt_file=True)
    vw.histogram_2D_data_range(g1, 'Green channel', 'Value', 'Frequency', '02_Green_pil', output_path, 0, 255, 1,
                               txt_file=True)
    vw.histogram_2D_data_range(b1, 'Blue channel', 'Value', 'Frequency', '03_Blue_pil', output_path, 0, 255, 1,
                               txt_file=True)

    vw.histogram_2D_data_range(r2, 'Red channel', 'Value', 'Frequency', '04_Red_cca', output_path, 0, 255, 1,
                               txt_file=True)
    vw.histogram_2D_data_range(g2, 'Green channel', 'Value', 'Frequency', '05_Green_cca', output_path, 0, 255, 1,
                               txt_file=True)
    vw.histogram_2D_data_range(b2, 'Blue channel', 'Value', 'Frequency', '06_Blue_cca', output_path, 0, 255, 1,
                               txt_file=True)
...
def color_balancing(img, output_path):
    ...
    plt.imsave(f'{output_path}IMG/07_cca_automatic_color_equalization.jpg', automatic_color_equalization)

    luminance_weighted_gray_world = cca.luminance_weighted_gray_world(img)
    plt.imsave(f'{output_path}IMG/08_cca_luminance_weighted_gray_world.jpg', luminance_weighted_gray_world)

    standard_deviation_weighted_grey_world = cca.standard_deviation_weighted_grey_world(img)
    plt.imsave(f'{output_path}IMG/09_cca_standard_deviation_weighted_grey_world.jpg',standard_deviation_weighted_grey_world)

    standard_deviation_and_luminance_weighted_gray_world = cca.standard_deviation_and_luminance_weighted_gray_world(img)
    plt.imsave(f'{output_path}IMG/10_cca_standard_deviation_and_luminance_weighted_gray_world.jpg',standard_deviation_and_luminance_weighted_gray_world)
...
def cytoplasm_RGB_channels(img,output_path):
    ...
    img_cytoplasm_boundary = sd.get_boundary_4_connected(img_labeled_cytoplasm, width, height)
    img_cytoplasm_boundary_bin = cw.convert_labeled_to_bin(img_cytoplasm_boundary)
    plt.imsave(f'{output_path}IMG/06_red_cytoplasm_boundary.jpg', img_cytoplasm_boundary_bin, cmap='gray')
    ...
    img_cytoplasm_boundary = sd.get_boundary_4_connected(img_labeled_cytoplasm, width, height)
    img_cytoplasm_boundary_bin = cw.convert_labeled_to_bin(img_cytoplasm_boundary)
    plt.imsave(f'{output_path}IMG/12_green_cytoplasm_boundary.jpg', img_cytoplasm_boundary_bin, cmap='gray')
    ...
    img_cytoplasm_boundary = sd.get_boundary_4_connected(img_labeled_cytoplasm, width, height)
    img_cytoplasm_boundary_bin = cw.convert_labeled_to_bin(img_cytoplasm_boundary)
    plt.imsave(f'{output_path}IMG/18_blue_cytoplasm_boundary.jpg', img_cytoplasm_boundary_bin, cmap='gray')
...
def nuclei_RGB_channels(img, output_path):
    ...
    plt.imsave(f'{output_path}IMG/04_red_channel_otsu_noise_removed.jpg', r_bin_otsu_morp, cmap='gray')
    ...
    plt.imsave(f'{output_path}IMG/10_green_channel_otsu_noise_removed.jpg', g_bin_otsu_morp, cmap='gray')
    ...
    img_nuclei_boundary = sd.get_boundary_4_connected(img_labeled_nuclei, width, height)
    img_nuclei_boundary_bin = cw.convert_labeled_to_bin(img_nuclei_boundary)
    plt.imsave(f'{output_path}IMG/12_green_nuclei_boundary.jpg', img_nuclei_boundary_bin, cmap='gray')
    ...
    b_bin_otsu_morp = iw.close_holes_remove_noise(b_bin_otsu)
    plt.imsave(f'{output_path}IMG/16_blue_channel_otsu_noise_removed.jpg', b_bin_otsu_morp, cmap='gray')
    ...
    img_nuclei_boundary = sd.get_boundary_4_connected(img_labeled_nuclei, width, height)
    img_nuclei_boundary_bin = cw.convert_labeled_to_bin(img_nuclei_boundary)
    plt.imsave(f'{output_path}IMG/18_blue_nuclei_boundary.jpg', img_nuclei_boundary_bin, cmap='gray')
...
def rel_representation_in_xyz(img,output_path):
    ...
    # ------------------ Zde kód pro analýzu ------------------------
    e = ['H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca',
